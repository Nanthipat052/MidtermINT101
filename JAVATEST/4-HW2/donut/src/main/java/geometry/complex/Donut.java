...
public class Donut {
    // create and set the default minimum thickness of donut (DEFAULT_THICKNESS) to 3.0
    ...
    */
    ...
    the thickness of the Donut (= outer radius - inner radius) is the DEFAULT_THICKNESS.
    */
    ...
    */
    ...
    public double getInnerRadius() { return innerCircle.getRadius(); }
    public double getOuterRadius() { return outerCircle.getRadius(); }
